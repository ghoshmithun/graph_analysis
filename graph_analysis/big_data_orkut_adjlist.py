...
import time
import pickle
WRITE_FILE='../adjacency_list_big.txt'
DEGREE_FILE_BIG ='../degree_file_from_adjacency_big.pickle'
BIG_GRAPH_FILE = '/Users/mghosh2/Downloads/soc-orkut-dir/soc-orkut-dir.edges'
...
DEGREE_FILE_BIG = get_path(DEGREE_FILE_BIG)
...
if __name__ == '__main__':
    graph = create_graph(BIG_GRAPH_FILE,line_to_skip=1)
