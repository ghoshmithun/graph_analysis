...
import time
import pickle
WRITE_FILE='../edgelist_list_small.txt'
DEGREE_FILE_SMALL ='../degree_file_from_edgelist_small.pickle'
...
DEGREE_FILE_SMALL = get_path(DEGREE_FILE_SMALL)
...
if __name__ == '__main__':
    ...
    with open(WRITE_FILE,'w') as wf:
        ...
        save_pickle(degree_values,DEGREE_FILE_SMALL)
